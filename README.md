...
- [x] Explain what a token is used for.
  ...
  - to authenticate the user before allowing access to a protected route

- [x] What steps can you take in your web apps to keep your data secure?

  - use private routes and authentication so that the protected data can only be accessed by a user with the required credentials

- [x] Describe how web servers work.

  - web servers send and receive data for websites and apps using a combination of software and hardware
